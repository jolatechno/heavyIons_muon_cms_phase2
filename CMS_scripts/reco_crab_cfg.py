...
config.General.requestName = 'step3_RECO'
...
config.JobType.psetName = 'step3.py' # name of the script created by the cmsDriver.py command
...
config.Data.inputDataset = '/step1_heavy_ion/jtouzet-step2_DIGI_RAW-90e3e65d7e30b0fd02ab1f83a2a9fa2d/USER'
